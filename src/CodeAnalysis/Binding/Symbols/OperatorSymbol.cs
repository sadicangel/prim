...
internal sealed record class OperatorSymbol(SyntaxNode Syntax, Operator Operator)
    : MemberSymbol(GetBoundKind(Operator.OperatorKind), Syntax, Operator.Name, IsReadOnly: true)
{
