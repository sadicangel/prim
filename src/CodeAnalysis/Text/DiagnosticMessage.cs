...
public static class DiagnosticMessage
{
    ...
    public static string UndefinedUnaryOperator(Token @operator, TypeSymbol operandType) => $"Unary operator '{@operator}' is not defined for type '{operandType}'";

    public static string UndefinedBinaryOperator(Token @operator, TypeSymbol leftType, TypeSymbol rightType) => $"Binary operator '{@operator}' is not defined for types '{leftType}' and '{rightType}'";

    public static string AmbiguousBinaryOperator(Token @operator, TypeSymbol leftType, TypeSymbol rightType) => $"Binary operator '{@operator}' is ambiguous on operands of type '{leftType}' and '{rightType}'";
