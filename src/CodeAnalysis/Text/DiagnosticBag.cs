...
public readonly record struct TypeSymbol(string Name);
...
public sealed class DiagnosticBag : IReadOnlyDiagnosticBag
{
    ...
    public void ReportInvalidNumber(SourceLocation location, string text, TypeSymbol type) => ReportError(location, DiagnosticMessage.InvalidNumber(text, type));
    ...
    public void ReportUndefinedUnaryOperator(Token @operator, TypeSymbol operandType) => ReportError(@operator.Location, DiagnosticMessage.UndefinedUnaryOperator(@operator, operandType));
    public void ReportUndefinedBinaryOperator(Token @operator, TypeSymbol leftType, TypeSymbol rightType) => ReportError(@operator.Location, DiagnosticMessage.UndefinedBinaryOperator(@operator, leftType, rightType));
    public void ReportAmbiguousBinaryOperator(Token @operator, TypeSymbol leftType, TypeSymbol rightType) => ReportError(@operator.Location, DiagnosticMessage.AmbiguousBinaryOperator(@operator, leftType, rightType));
    ...
    public void ReportInvalidConversion(SourceLocation location, TypeSymbol sourceType, TypeSymbol destinationType) => ReportError(location, DiagnosticMessage.InvalidConversion(sourceType, destinationType));
    public void ReportInvalidImplicitConversion(SourceLocation location, TypeSymbol sourceType, TypeSymbol destinationType) => ReportError(location, DiagnosticMessage.InvalidImplicitConversion(sourceType, destinationType));
    ...
    public void ReportInvalidArgumentType(SourceLocation location, string parameterName, TypeSymbol expectedType, TypeSymbol actualType) => ReportError(location, DiagnosticMessage.InvalidArgumentType(parameterName, expectedType, actualType));
    public void ReportInvalidExpressionType(SourceLocation location, TypeSymbol actualType) => ReportError(location, DiagnosticMessage.InvalidExpressionType(actualType));
    public void ReportInvalidVariableType(SourceLocation location, TypeSymbol expectedType, TypeSymbol actualType) => ReportError(location, DiagnosticMessage.InvalidVariableType(expectedType, actualType));
    public void ReportInvalidExpressionType(SourceLocation location, TypeSymbol expectedType, TypeSymbol actualType) => ReportError(location, DiagnosticMessage.InvalidExpressionType(expectedType, actualType));
    ...
    public void ReportInvalidReturnExpression(SourceLocation location, string functionName, TypeSymbol expectedType) => ReportError(location, DiagnosticMessage.InvalidReturnExpression(functionName, expectedType));
