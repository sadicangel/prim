...
public partial class ParserTests
{
    ...
    public void Parse_TrueLiteralExpression()
    {
        ...
        Assert.Equal(SyntaxKind.TrueLiteralExpression, node.Kind);
    }
    ...
    public void Parse_FalseLiteralExpression()
    {
        ...
        Assert.Equal(SyntaxKind.FalseLiteralExpression, node.Kind);
    }
    ...
    public void Parse_NullLiteralExpression()
    {
        ...
        Assert.Equal(SyntaxKind.NullLiteralExpression, node.Kind);
    }
    ...
    public void Parse_I8LiteralExpression()
    {
        ...
        Assert.Equal(SyntaxKind.I8LiteralExpression, node.Kind);
    }
    ...
    public void Parse_U8LiteralExpression()
    {
        ...
        Assert.Equal(SyntaxKind.U8LiteralExpression, node.Kind);
    }
    ...
    public void Parse_I16LiteralExpression()
    {
        ...
        Assert.Equal(SyntaxKind.I16LiteralExpression, node.Kind);
    }
    ...
    public void Parse_U16LiteralExpression()
    {
        ...
        Assert.Equal(SyntaxKind.U16LiteralExpression, node.Kind);
    }
    ...
    public void Parse_I32LiteralExpression()
    {
        ...
        Assert.Equal(SyntaxKind.I32LiteralExpression, node.Kind);
    }
    ...
    public void Parse_U32LiteralExpression()
    {
        ...
        Assert.Equal(SyntaxKind.U32LiteralExpression, node.Kind);
    }
    ...
    public void Parse_I64LiteralExpression()
    {
        ...
        Assert.Equal(SyntaxKind.I64LiteralExpression, node.Kind);
    }
    ...
    public void Parse_U64LiteralExpression()
    {
        ...
        Assert.Equal(SyntaxKind.U64LiteralExpression, node.Kind);
    }
    ...
    public void Parse_F16LiteralExpression()
    {
        ...
        Assert.Equal(SyntaxKind.F16LiteralExpression, node.Kind);
    }
    ...
    public void Parse_F32LiteralExpression()
    {
        ...
        Assert.Equal(SyntaxKind.F32LiteralExpression, node.Kind);
    }
    ...
    public void Parse_F64LiteralExpression()
    {
        ...
        Assert.Equal(SyntaxKind.F64LiteralExpression, node.Kind);
    }
    ...
    public void Parse_StrLiteralExpression()
    {
        ...
        Assert.Equal(SyntaxKind.StrLiteralExpression, node.Kind);
    }
}
